...
export function SessionActionMenu(props: SessionActionMenuProps) {
    ...
    const showResume = !sessionActive && lifecycleState !== 'archived' && Boolean(onResume)
        ...
        >
            ...
            >
                ...
                {showResume ? (
                    ...
                    >
                        <PlayIcon className="text-[var(--app-hint)]" />
